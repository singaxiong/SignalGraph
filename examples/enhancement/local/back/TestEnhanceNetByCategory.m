...
% dnn1 = load('nnet/EnhanceGaussian.noCMN.stage1.expDecay.Decay0.999.DeltaByEqn.MbSize40.U28539.771-L-2048-Mu-Var-771.L2_0.LR_3E-3/nnet.itr37.LR5.33E-6.CV1467.491.mat');
dnn1 = load('nnet/EnhanceRegression.noCMN.DeltaByEqn.MbSize40.U28539.771-LSTM-2048-771.L2_3E-4.LR_3E-3/nnet.itr37.LR1E-5.CV2453.828.mat');
% dnn2 = load('nnet/EnhanceGaussian.noCMN.stage3.0.init1.expDecay.Decay0.999.DeltaByEqn.MbSize40.U28539.771-L-2048-Mu-Var-771.L2_0.LR_3E-3/nnet.itr17.LR1.73E-4.CV787.927.mat');
dnn2 = load('nnet/EnhanceRegression.noCMN.DeltaByEqn.MbSize20.U28539.771-LSTM-2048-771.L2_3E-4.LR_1E-4/nnet.itr62.LR4.97E-8.CV2439.245.mat');
dnn3 = load('nnet/EnhanceGaussian.noCMN.init1.expDecay.Decay0.999.DeltaByEqn.MbSize40.U28539.771-LSTM-2048-771.L2_0.LR_3E-3/nnet.itr26.LR3.62E-5.CV756.273.mat');
...
if testSet==1
    ...
    para1.local.cv_wav_root = ['D:\Data\NoiseData\Libri\LibriSpeech\test-clean-distorted\Sent100\T60-' num2str(T60) '_' noise '_SNR' num2str(SNR) 'dB'];
...
for i = 33:1:length(Data_cv(1).data)
    ...
    figure(1); imagesc(CMN([noisyLogSpec{1}; enhancedLogSpecLogMMSE; mask{1}*10; enhancedLogSpec{1}(1:257,:); mask{2}*10; enhancedLogSpec{2}(1:257,:); enhancedLogSpec{3}(1:257,:); cleanLogSpec{1}(1:257,:)]')');
    title(i); pause(0.01);
    ...
    if playSound
        ...
        soundsc(enhanced_wav{3}(1:playDur), 16000);                pause
    end
    
    clean_wav = double(InputReader(DataTmp(2).data{1}, para1.IO.fileReader(2)));
    
    fprintf('%s - %s\n', dos2unix(noisyFile), datestr(now));
    
    pesq_scores(i,1) = pesq_fast_vectorize(clean_wav, noisy_wav, 0, 16000);
...
save('nnet/pesq.mat', 'pesq_scores');
end
