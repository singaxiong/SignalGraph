...
para.local.wavroot_noisy = ChoosePath4OS({[chime_root '/audio/16kHz/isolated'], '/media/kiwi_w1/sns706/data/audio/16kHz/isolated'});
para.local.wavroot_clean = ChoosePath4OS({[chime_root '/audio/16kHz/isolated/tr05_org'], '/media/kiwi_w1/sns706/data/audio/16kHz/isolated/tr05_org'});
...
para.topology.initialMask = 'nnet/LSTM_Mask1chOfficial.U8395.771-512-512-257.L2_3E-4.LR_3E-2/nnet.itr8.LR2.4E-4.CV10.487.mat';    % the initial mask prediction network. If you don't provide the intial network, random initialization will be used. 
...
para.topology.hiddenLayerSizeMask = [512 512];     % size of LSTM mask prediction network
...
[Data_small, para] = LoadWavLabel_CHiME4(para, 400, 'tr05');      % load a small amount of data for initialization purpose
...
[Data_tr, para] = LoadWavLabel_CHiME4(para, 100, 'tr05');
[Data_cv, para] = LoadWavLabel_CHiME4(para, 500, 'dt05');     % we only use 1/5 of dev data as cv data for speed. 
