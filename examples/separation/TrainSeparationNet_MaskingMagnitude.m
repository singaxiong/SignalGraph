...
%
%clear
function TrainSeparationNet_MaskingMagnitude(hiddenLayerSize, hiddenLayerSizeFF, learning_rate, nUtt4Iteration, useCMN, useGPU)
modelType = 'LSTM';
...
[layer, para] = Build_SeparationNet_MaskingMagnitude(Data_tr, para);

% load the cv data
para.local.cv_wav_root = ChoosePath4OS({'D:\Data\NoiseData\Libri\LibriSpeech\dev-separation.SPR0', '/media/xiaoxiong/OS/data1/G/Libri/LibriSpeech/dev-separation'}); 
para.local.useFileName = 0;
[Data_cv, para] = LoadSeparationWav_Libri(para, 1);
