...
function [layer, WeightTyingSet] = genNetworkFF_Pairwise2(inputDim, hiddenLayerSize, distanceBeforeActivation, distance_type, costFn)
...
% layer = [feature_net feature_net2 dist_node];
